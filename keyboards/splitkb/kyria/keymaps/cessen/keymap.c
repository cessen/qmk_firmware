 ...
 * |-----------+-----+-----+------+------+----------+-----------------.  ,---------------+----------+------+------+-----+-----+----------|
 * | Ctrl/Alt  |  G  |  X  |   J  |   K  |   / ?    | Bksp  |   Sup   |  |  Sup   | Entr |   - _    |   R  |   M  |  F  |  P  | Ctrl/Alt |
 * `-----------------------+------+------+----------+-------+---------|  |--------+------+----------+------+------+----------------------'
 ...
 */
    [_ENGRAM] = LAYOUT(
     ...
     CTRL_ALT,  KC_G , KC_X , KC_J    , KC_K    , KC_SLSH , KC_BSPC , KC_LGUI ,     KC_LGUI , KC_ENT , KC_MINS , KC_R    , KC_M    , KC_F , KC_P , CTRL_ALT,
