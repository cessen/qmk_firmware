 ...
 *
 * ,----------------------------------------.                                        ,--------------------------------------.
 * | Tab |  Z  |  Y  |  O   |  U  |    /    |                                        |   ,    |  L  |  D  |  W  |  Q  | Tab |
 * |-----+-----+-----+------+-----+---------|                                        |--------+-----+-----+-----+-----+-----|
 * | Esc |  C  |  I  |  E   |  A  |    '    |                                        |   B    |  H  |  T  |  S  |  N  |  V  |
 * |-----+-----+-----+------+-----+---------+------------------.  ,------------------+--------+-----+-----+-----+-----+-----|
 * | Tab |  G  |  X  |  J   |  K  |    _    | Enter |   Sup    |  |   Sup    | Bksp  |   .    |  R  |  M  |  F  |  P  | Del |
 * `-----------------+------+-----+---------+-------+----------|  |----------+-------+--------+-----+-----+-----------------'
 ...
 */
    [_ENGRAM] = LAYOUT(
     KC_TAB  , KC_Z , KC_Y , KC_O    , KC_U    , KC_SLSH ,                                             KC_COMM , KC_L    , KC_D    , KC_W , KC_Q , KC_TAB ,
     KC_ESC  , KC_C , KC_I , KC_E    , KC_A    , KC_QUOT ,                                             KC_B    , KC_H    , KC_T    , KC_S , KC_N , KC_V   ,
     KC_TAB  , KC_G , KC_X , KC_J    , KC_K    , KC_UNDS , KC_ENT  , KC_LGUI ,     KC_LGUI , KC_BSPC , KC_DOT  , KC_R    , KC_M    , KC_F , KC_P , KC_DEL ,
 ...
 */
    [_NAV] = LAYOUT(
      XXXXXXX, XXXXXXX, KC_ASTR, KC_SLSH, KC_CIRC, KC_PERC,                                     KC_PGUP, KC_HOME, KC_UP  , KC_END , XXXXXXX, XXXXXXX,
      XXXXXXX, KC_COLN, KC_PLUS, KC_MINS, KC_EQL , KC_AMPR,                                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
      XXXXXXX, KC_TILD, KC_PIPE, KC_LT  , KC_GT  , KC_GRV , _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
